...
const pendingStatuses = new Set(["维修中", "待检测", "待报价确认", "待交付检测", "检测中", "已报价", "待分配", "待指派", "待备料", "待维修", "待质检", "待收费", "部分收款"]);
const warningStatuses = new Set(["同行挂账", "财务待确认", "未收款", "待支付", "已收款待确认"]);
const successStatuses = new Set(["回收库存", "在库可用", "启用", "开启", "开启接单"]);
const errorStatuses = new Set(["已取消", "已删除", "取消", "失败", "异常", "质检不通过", "关闭", "关闭接单"]);
